...
You can use the `lstm.py` file to run and test the codes. First you should change the dataset path, then you can run the main method. It will take a long time since it is training a deep neural network. Process is same for the naive_bayes_knn.py file.
